...
5. Kernel type
    The compiler can support both OpenCL and CUDA kernel code. The compiler detects the input file type automatically, and takes argument "outtype" as output file type.
    "test/test_cl_matmul.sh" is the OpenCL example of matrix multiplication.
