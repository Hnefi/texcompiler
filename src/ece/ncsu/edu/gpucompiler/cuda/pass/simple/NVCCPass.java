...
//			System.out.println(OS+"-"+nvcc);
			File file = procedure.gerenateRAWOutput(new File(System.getProperty("java.io.tmpdir")), procedure.getProcedure().getSymbolName()+"_input.cu", FileFormatter.FILE_CUDA);
