...
public NewCLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("__real", this), new Integer(105));
	literals.put(new ANTLRHashString("case", this), new Integer(63));
	literals.put(new ANTLRHashString("short", this), new Integer(31));
	literals.put(new ANTLRHashString("break", this), new Integer(61));
	literals.put(new ANTLRHashString("while", this), new Integer(56));
	literals.put(new ANTLRHashString("__global", this), new Integer(24));
	literals.put(new ANTLRHashString("typeof", this), new Integer(42));
	literals.put(new ANTLRHashString("__shared__", this), new Integer(27));
	literals.put(new ANTLRHashString("inline", this), new Integer(19));
	literals.put(new ANTLRHashString("unsigned", this), new Integer(37));
	literals.put(new ANTLRHashString("const", this), new Integer(26));
	literals.put(new ANTLRHashString("float", this), new Integer(34));
	literals.put(new ANTLRHashString("__local", this), new Integer(25));
	literals.put(new ANTLRHashString("return", this), new Integer(62));
	literals.put(new ANTLRHashString("sizeof", this), new Integer(101));
	literals.put(new ANTLRHashString("do", this), new Integer(57));
	literals.put(new ANTLRHashString("__label__", this), new Integer(55));
	...
	literals.put(new ANTLRHashString("double", this), new Integer(35));
	literals.put(new ANTLRHashString("volatile", this), new Integer(10));
	literals.put(new ANTLRHashString("union", this), new Integer(13));
	literals.put(new ANTLRHashString("_Imaginary", this), new Integer(40));
	...
	literals.put(new ANTLRHashString("_Complex", this), new Integer(39));
	literals.put(new ANTLRHashString("int", this), new Integer(32));
	literals.put(new ANTLRHashString("for", this), new Integer(58));
	literals.put(new ANTLRHashString("char", this), new Integer(30));
	literals.put(new ANTLRHashString("__constant__", this), new Integer(28));
	literals.put(new ANTLRHashString("default", this), new Integer(64));
	literals.put(new ANTLRHashString("__host__", this), new Integer(22));
	literals.put(new ANTLRHashString("__imag", this), new Integer(106));
	literals.put(new ANTLRHashString("__alignof", this), new Integer(102));
	literals.put(new ANTLRHashString("static", this), new Integer(18));
	literals.put(new ANTLRHashString("_Bool", this), new Integer(38));
	literals.put(new ANTLRHashString("continue", this), new Integer(60));
	literals.put(new ANTLRHashString("bool", this), new Integer(41));
	literals.put(new ANTLRHashString("struct", this), new Integer(12));
	literals.put(new ANTLRHashString("signed", this), new Integer(36));
	...
	literals.put(new ANTLRHashString("switch", this), new Integer(67));
	literals.put(new ANTLRHashString("long", this), new Integer(33));
	literals.put(new ANTLRHashString("__extension__", this), new Integer(150));
	literals.put(new ANTLRHashString("asm", this), new Integer(9));
	literals.put(new ANTLRHashString("__kernel", this), new Integer(23));
	literals.put(new ANTLRHashString("__complex", this), new Integer(45));
}
