...
public class Specifier implements Printable
{
  ...
  /* The following type-specifiers are added to support C99
  *  keywords */
   ...
   * FOr Opencl
   */
  public static final Specifier OPENCL_KERNEL	= new Specifier(46);
  public static final Specifier OPENCL_GLOBAL 	= new Specifier(47);
  public static final Specifier OPENCL_LOCAL 	= new Specifier(48);
